...
RSpec.describe VesselsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested vessel as @vessel" do
      vessel = Vessel.create! valid_attributes
      get :show, params: {id: vessel.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested vessel as @vessel" do
      vessel = Vessel.create! valid_attributes
      get :edit, params: {id: vessel.to_param}, session: valid_session
      expect(assigns(:vessel)).to eq(vessel)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Vessel" do
        expect {
          post :create, params: {vessel: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved vessel as @vessel" do
        post :create, params: {vessel: invalid_attributes}, session: valid_session
        expect(assigns(:vessel)).to be_a_new(Vessel)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested vessel" do
        vessel = Vessel.create! valid_attributes
        put :update, params: {id: vessel.to_param, vessel: new_attributes}, session: valid_session
        vessel.reload
      ...
      it "assigns the requested vessel as @vessel" do
        vessel = Vessel.create! valid_attributes
        put :update, params: {id: vessel.to_param, vessel: valid_attributes}, session: valid_session
        expect(assigns(:vessel)).to eq(vessel)
      end
    ...
    context "with invalid params" do
      it "assigns the vessel as @vessel" do
        vessel = Vessel.create! valid_attributes
        put :update, params: {id: vessel.to_param, vessel: invalid_attributes}, session: valid_session
        expect(assigns(:vessel)).to eq(vessel)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested vessel" do
      vessel = Vessel.create! valid_attributes
      expect {
        delete :destroy, params: {id: vessel.to_param}, session: valid_session
      }.to change(Vessel, :count).by(-1)
    end
